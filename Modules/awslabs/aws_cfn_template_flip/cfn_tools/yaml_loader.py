"""
FROM: https://github.com/awslabs/aws-cfn-template-flip/blob/master/cfn_tools/yaml_loader.py
Modified by: Mike Mosher
"""
...
def multi_constructor(loader, tag_suffix, node):
    ...
    # Changing this to just return a normal dict
    # return OrderedDict((
